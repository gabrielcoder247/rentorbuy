...
#         # user = request.user.listing.profile
...
#     return render(request, 'booking_form.html', {"title":title,"booking_form": booking_form,"timeslot":timeslot,"listing":listing,"current_user":current_user})
